...
: dt_(dt), max_(max), min_(min), kp_(kp), kd_(kd), ki_(ki), max_integral_(1.0), pre_error_(0), integral_(0)
{
}
...
void PID::setMaxIntegral(double max_integral) { max_integral_ = max_integral; }
